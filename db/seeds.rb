...
celebrity.photos.attach(io: file, filename: "jackson.png", content_type: "image/png")
celebrity.save!
...
celebrity_rihanna.photos.attach(io: file_rihanna, filename: "rihanna.jpg", content_type: "image/png")
...
celebrity_beyonce.photos.attach(io: file_beyonce, filename: "beyonce.png", content_type: "image/png")
